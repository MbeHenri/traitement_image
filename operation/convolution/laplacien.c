...
int main(int argc, char const *argv[])
{
    ...
    {
        f=fopen("helpAll/laplacien.help", "r");
        int car = 0;
        if (f != NULL)
        {
    ...
    else if (strcmp(ch, "P2") == 0)
    {
        ...
        if (argv[2] == NULL)
        {
            printf("[ donnez l'indicateur du laplacien ]\n");
            free_ImageG(img);
            exit(1);
        }
        int indicateur = -1;
        if (strcmp(argv[2], "1") == 0){
            ...
            printf("[ l'indicateur du laplacien n'est pas pris en charge ]\n");
            free_ImageG(img);
            exit(1);
        }
        ...
        if (argv[3] == NULL)
        {
            ...
            dest1 = malloc((15+strlen(info->name)+strlen(current_dir))*sizeof(char));
            dest1[0]='\0';
        ...
        if (dest1!=NULL)
        {
            ...
            if (indicateur==1)
            {
                filtre1->data[0][0]=0;filtre1->data[0][1]=1;filtre1->data[0][2]=0;
                filtre1->data[1][0]=1;filtre1->data[1][1]=-4;filtre1->data[1][2]=1;
                filtre1->data[2][0]=0;filtre1->data[2][1]=1;filtre1->data[2][2]=0;
            }else if(indicateur==0){
                filtre1->data[0][0]=1;filtre1->data[0][1]=1;filtre1->data[0][2]=1;
                filtre1->data[1][0]=1;filtre1->data[1][1]=-8;filtre1->data[1][2]=1;
                filtre1->data[2][0]=1;filtre1->data[2][1]=1;filtre1->data[2][2]=1;
            }
            printf("...");
            ImageG *r = convolutionG(img, filtre1);
            printf("\n");
            free_Filtre(filtre1);
            write_G(r, dest1);
            free_ImageG(r);
